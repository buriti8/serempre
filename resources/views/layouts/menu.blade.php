...
<head>
    ...
    <link rel="icon" href="{{asset('img/logo-Serempre.png')}}" type="image/png" sizes="16x16">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-3 sidebar-light-warning">
            <a href="{{ route('home') }}" class="brand-link logo-switch">
                <img src="{{ asset('img/logo-Serempre.png')}}?{{rand(0, 1000)}}" alt="LogoSmall"
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if(App\Validations\Validation::validate('customers'))
                        @if(App\Validations\Validation::permissionsUser('customers'))
                        <li class="nav-item">
                            <a href="{{ url('/customers') }}" class="nav-link">
                                <i class="nav-icon fas fa-user-tie"></i>
                                <p>
                                    @lang('base_lang.customers')
                                </p>
                            </a>
                        </li>
                        @endif
                        ...
                        @if(App\Validations\Validation::validate('cities'))
                        @if(App\Validations\Validation::permissionsUser('cities'))
                        <li class="nav-item">
                            <a href="{{ url('/cities') }}" class="nav-link">
                                <i class="nav-icon fas fa-map"></i>
                                <p>
                                    @lang('base_lang.cities')
                                </p>
                            </a>
                        </li>
                        @endif
